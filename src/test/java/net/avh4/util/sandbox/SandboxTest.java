...
public class SandboxTest {
    ...
    @Test
    public void testCreateFilesFromResourcesInSpecificPaths() throws Exception {
        final Sandbox s = new Sandbox();
        s.useResource("file_in_jar.txt", "src/resources/file.txt");

        final String fileContents = FileUtils.readFileToString(s.
                newFile("src/resources/file.txt"));
        assertThat(fileContents, is("MAGIC NUMBER 3849"));
    }
